...
- **Task Delegation**: `/Users/humanshell/.config/opencode/context/core/workflows/task-delegation-basics.md` — How to reference external context in sessions
- **Session Management**: `/Users/humanshell/.config/opencode/context/core/workflows/session-management.md` — Session lifecycle
