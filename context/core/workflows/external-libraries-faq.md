...
**Rule**: If it's not in `/Users/humanshell/.config/opencode/context/`, use ExternalScout.
...
| **Location** | `/Users/humanshell/.config/opencode/context/` | Internet (Context7, docs) |
