...
```bash
npx ts-node /Users/humanshell/.config/opencode/context/tasks/scripts/task-cli.ts <command> [args]
```
...
See `/Users/humanshell/.config/opencode/context/core/workflows/multi-stage-orchestration.md` for the complete workflow.
