...
| **Context files** | `/Users/humanshell/.config/opencode/context/` |
...
| **New context** | `/Users/humanshell/.config/opencode/context/{category}/{name}.md` |
...
```
/Users/humanshell/.config/opencode/context/{category}/{topic}.md
```

**Examples**:
- `/Users/humanshell/.config/opencode/context/core/standards/code-quality.md`
- `/Users/humanshell/.config/opencode/context/ui/web/react-patterns.md`
- `/Users/humanshell/.config/opencode/context/content-creation/principles/copywriting-frameworks.md`
...
```bash
# By category
ls /Users/humanshell/.config/opencode/context/{category}/

# All context
find /Users/humanshell/.config/opencode/context -name "*.md"
```
