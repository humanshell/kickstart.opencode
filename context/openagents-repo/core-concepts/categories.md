...
/Users/humanshell/.config/opencode/context/development/
├── navigation.md
├── clean-code.md
├── react-patterns.md
└── api-design.md
...
mkdir -p /Users/humanshell/.config/opencode/context/{category}
...
```bash
cat > /Users/humanshell/.config/opencode/context/{category}/navigation.md << 'EOF'
...
```
/Users/humanshell/.config/opencode/context/{category}/
...
Loads: `/Users/humanshell/.config/opencode/context/ui/web/react-patterns.md`
