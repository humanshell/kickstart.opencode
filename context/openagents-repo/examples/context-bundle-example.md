...
**Core Standards**:
- `/Users/humanshell/.config/opencode/context/core/standards/code-quality.md` → Modular, functional code patterns
- `/Users/humanshell/.config/opencode/context/core/standards/test-coverage.md` → Testing requirements and TDD
- `/Users/humanshell/.config/opencode/context/core/standards/documentation.md` → Documentation standards

**Core Workflows**:
- `/Users/humanshell/.config/opencode/context/core/workflows/feature-breakdown.md` → Task breakdown methodology

## Repository-Specific Context (Load These Before Starting)

**Quick Start** (ALWAYS load first):
- `/Users/humanshell/.config/opencode/context/openagents-repo/quick-start.md` → Repo orientation and common commands

**Core Concepts** (Load based on task type):
- `/Users/humanshell/.config/opencode/context/openagents-repo/core-concepts/agents.md` → How agents work
- `/Users/humanshell/.config/opencode/context/openagents-repo/core-concepts/evals.md` → How testing works
- `/Users/humanshell/.config/opencode/context/openagents-repo/core-concepts/registry.md` → How registry works
- `/Users/humanshell/.config/opencode/context/openagents-repo/core-concepts/categories.md` → How organization works

**Guides** (Load for specific workflows):
- `/Users/humanshell/.config/opencode/context/openagents-repo/guides/adding-agent-basics.md` → Step-by-step agent creation
- `/Users/humanshell/.config/opencode/context/openagents-repo/guides/testing-agent.md` → Testing workflow
- `/Users/humanshell/.config/opencode/context/openagents-repo/guides/updating-registry.md` → Registry workflow
...
- `/Users/humanshell/.config/opencode/context/navigation.md` - Add data category context if needed
