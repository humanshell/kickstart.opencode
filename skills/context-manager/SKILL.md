...
### 5. Compress Files
```bash
bash .opencode/skills/context-manager/router.sh compress /Users/humanshell/.config/opencode/context/ 100KB
```
Reduces large context files to save space.

### 6. Organize Context
```bash
bash .opencode/skills/context-manager/router.sh organize /Users/humanshell/.config/opencode/context/
```
...
### 8. Guided Workflow
```bash
bash .opencode/skills/context-manager/router.sh process "organize authentication context" /Users/humanshell/.config/opencode/context/
```
...
./router.sh discover "/Users/humanshell/.config/opencode/context/core/"
```
...
./router.sh extract "/Users/humanshell/.config/opencode/context/core/" "all standards"
```
...
./router.sh compress "/Users/humanshell/.config/opencode/context/" "100 KB"

# Compress all context
./router.sh compress "/Users/humanshell/.config/opencode/context/"

# Compress and archive
./router.sh compress "/Users/humanshell/.config/opencode/context/development/" "50 KB"
```
...
./router.sh organize "/Users/humanshell/.config/opencode/context/development/"
```
...
./router.sh process "organize authentication context" "/Users/humanshell/.config/opencode/context/development/"

# Process all development context
./router.sh process "organize all development context" "/Users/humanshell/.config/opencode/context/development/"
