...
- Locate context directories (`/Users/humanshell/.config/opencode/context/`, `docs/`, `.context/`, etc.)
...
```
/Users/humanshell/.config/opencode/context/
...
```bash
list(path="/Users/humanshell/.config/opencode/context")
```
...
list(path="/Users/humanshell/.config/opencode/context/{category}")

# Read relevant files
read(filePath="/Users/humanshell/.config/opencode/context/{category}/{file}.md")
```
...
**Context Location**: `/Users/humanshell/.config/opencode/context/`
**Files Searched**: 12
...
#### ⭐⭐⭐⭐⭐ Code Standards
**Path**: `/Users/humanshell/.config/opencode/context/core/standards/code.md`
...
/Users/humanshell/.config/opencode/context/core/workflows/
└── review.md ⭐ FOUND
```
...
3. `/Users/humanshell/.config/opencode/context/core/workflows/review.md` - Code review expectations
...
### Additional Context Available
If you need more information on:
- **Code standards** → Check `/Users/humanshell/.config/opencode/context/core/standards/code.md`
- **Testing guidelines** → Check `/Users/humanshell/.config/opencode/context/core/standards/tests.md`
```

## Discovery Patterns

### Pattern 1: Well-Organized Context
Repository has clear context structure (`/Users/humanshell/.config/opencode/context/` or `docs/`)
