...
<workflow>
  ...
  <step_4 name="CreateProjectContext">
    Create `/Users/humanshell/.config/opencode/context/project/{agent-name}-context.md` (CLAUDE.md pattern):
  ...
  <step_7 name="DeliverAgent">
    ...
    - `/Users/humanshell/.config/opencode/context/project/{agent-name}-context.md` - Project context (CLAUDE.md pattern)
