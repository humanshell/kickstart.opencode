...
<workflow id="analyze_context_dependencies">
  <stage id="1" name="ScanAgents" required="true">
    ...
    **Search patterns**:
    - `/Users/humanshell/.config/opencode/context/` (direct path references)
    - `@/Users/humanshell/.config/opencode/context/` (@ symbol references)
  ...
  <stage id="3" name="ValidateContextFiles" required="true">
    ...
    **Check existence**:
    ```bash
    test -f /Users/humanshell/.config/opencode/context/core/standards/code-quality.md
    ```
  ...
  <stage id="4" name="Report" required="true">
    ...
    **Uses but not declared**:
    - context:core/standards/code (referenced 3 times)
      - Line 64: "Code tasks → /Users/humanshell/.config/opencode/context/core/standards/code-quality.md (MANDATORY)"
      - Line 170: "Read /Users/humanshell/.config/opencode/context/core/standards/code-quality.md NOW"
...
```bash
grep -rn "\/Users/humanshell/.config/opencode/context/" .opencode/agent/ .opencode/command/
```
...
- `/Users/humanshell/.config/opencode/context/core/standards/code-quality.md` → `context:core/standards/code`
- `@/Users/humanshell/.config/opencode/context/openagents-repo/quick-start.md` → `context:openagents-repo/quick-start`
...
task(
  ...
  prompt=`
    ...
    2. Search for these patterns:
       - "/Users/humanshell/.config/opencode/context/core/" (direct paths)
       - "@/Users/humanshell/.config/opencode/context/" (@ references)
    ...
    4. For each context file in /Users/humanshell/.config/opencode/context/core/:
...
✓ /Users/humanshell/.config/opencode/context/core/context-system.md (1 reference)
  - Line 15: "Load: context:core/context-system"
✓ /Users/humanshell/.config/opencode/context/core/context-system/standards/mvi.md (2 references)
...
- **Context guide**: `/Users/humanshell/.config/opencode/context/openagents-repo/quality/registry-dependencies.md`
